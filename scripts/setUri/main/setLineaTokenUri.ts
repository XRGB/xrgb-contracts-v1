...
async function main() {
  ...
  const baseUri = "https://api.xrgb.xyz/api/nft/linea/xrgb/medadata/"

  const chainId = hre.network.config.chainId;
  if(chainId !== 59144){
    console.log("Error, not linea main network, please check..")
  }
  ...
  console.log("linea main network setUriTransaction successful: uri = ", baseUri)
}
