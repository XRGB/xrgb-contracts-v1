...
async function main() {
  ...
  const baseUri = "https://api-dev.xrgb.xyz/api/nft/base/xrgb/metadata/"

  const chainId = hre.network.config.chainId;
  if(chainId !== 84532){
    console.log("Error, not base sepolia network, please check..")
  }
  ...
  console.log("base sepolia network setUriTransaction successful: uri = ", baseUri)
}
