...
async function main() {
  ...
  const baseUri = "https://api-dev.xrgb.xyz/api/nft/bnb/xrgb/metadata/"

  const chainId = hre.network.config.chainId;
  if(chainId !== 97){
    console.log("Error, not bnb test network, please check..")
  }
  ...
  console.log("bnb test network setUriTransaction successful: uri = ", baseUri)
}
