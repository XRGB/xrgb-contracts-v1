...
async function main() {
  ...
  const baseUri = "https://api-dev.xrgb.xyz/api/nft/eth/xrgb/medadata/"

  const chainId = hre.network.config.chainId;
  if(chainId !== 5){
    console.log("Error, not eth goerli network, please check..")
  }
  ...
  console.log("eth goerli network setUriTransaction successful: uri = ", baseUri)
}
